...
@Component({
  selector: 'app-zelle-pay-authentication',
  templateUrl: './zelle-pay-authentication.component.html',
  styleUrls: ['./zelle-pay-authentication.component.scss']
})
export class ZellePayAuthenticationComponent implements OnInit {
